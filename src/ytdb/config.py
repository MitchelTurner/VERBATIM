...
class Settings:
    ...
    youtube_caption_delay: float = 5.0
...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        webshare_proxy_username=(os.getenv("WEBSHARE_PROXY_USERNAME") or "").strip() or None,
        webshare_proxy_password=(os.getenv("WEBSHARE_PROXY_PASSWORD") or "").strip() or None,
        youtube_http_proxy=(os.getenv("YOUTUBE_HTTP_PROXY") or "").strip() or None,
        youtube_https_proxy=(os.getenv("YOUTUBE_HTTPS_PROXY") or "").strip() or None,
        youtube_caption_delay=float(os.getenv("YOUTUBE_CAPTION_DELAY", "5")),
